...
"guiPane.entry.tcltk" <-
function (paneFrame, butArg, onArgEdit, varUseIt, dlg,
    item, ...)
{
...
"guiPane.list.tcltk" <-
function (paneFrame, butArg, onArgEdit, varUseIt, dlg, item, ...)
{
...
"guiDlg" <-
function (title = "Input", message = NULL, help = NULL, sep = NULL,
...
"guiDlgFunction" <-
function (fun, template = NULL, maxargs = 7, var = "res", width = 40,
    labelwidth = 10, displayit = TRUE, execfun = getOption("guiExecFun"))
{
    ...
    #### TO DO: use an existing template
    #### TO DO: deal with S3 and S4 generic functions!
...
"display.guiDlg" <-
function (x, parent = 0, GUI = getOption("guiWidgets"), debug = FALSE, ...)
{
    # Check arguments
